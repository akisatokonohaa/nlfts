...
useHead(() => ({
  ...
  link: [
    ...
    // Load optional search styling asynchronously.
    { rel: 'preload', as: 'style', href: 'https://cdn.jsdelivr.net/npm/@docsearch/css@3/dist/style.css', onload: "this.rel='stylesheet'" }
  ],
